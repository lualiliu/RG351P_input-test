...
static SDL_RASTER_TYPE DrawJoystickDot(const Sint32 JoystickX, const Sint32 JoystickY, const Sint16 CX, const Sint16 Y, SDL_RASTER_TYPE Text, const SDL_Color* Color)
{
